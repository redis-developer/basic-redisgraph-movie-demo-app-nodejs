    ...
    <div className={'details'}>
      <div className={'details-page'}>
        <div className={'detailsImg'}>
          {!film.poster ? (
            <img src={defaultFilm} alt="defaultFilm" />
          ) : (
        ...
        <div className={'details-information'}>
          <div>
            ...
            <p>
              Countries:{' '}
              {film.countries !== undefined &&
                film.countries.map((value, index) =>
            ...
            <p>Film duration: {film.runtime} min.</p>
            <p>
              Actors:{' '}
              {film.actors !== undefined &&
                film.actors.map((value, index) =>
            ...
            <p>{film.tagline}</p>
            <span>Rating of film: {film.imdbRating} of 10</span>
            <div className={'ratingLine'}>
              <div
                className={'ratingLineItem'}
      ...
      <div className={'details-film-actors'}>
        {film.directors !== undefined &&
          film.directors.map((value, index) => {
            return (
              <div
